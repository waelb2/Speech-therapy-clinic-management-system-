...
public class TestChoiceController implements HelloController.InitializeData {
        ...
        public void handleQstTestCreationClick(ActionEvent event) {
            try {
                HelloController.redirectPage(event, "QuestionsTestCreation.fxml", "Test de questions");
            } catch (Exception e) {
                e.getMessage();
            }
        }
